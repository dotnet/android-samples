    ...
    class AnimatorListener : Java.Lang.Object, Animator.IAnimatorListener
    {
        ...
        public void OnAnimationCancel(Animator animation)
        {
            if (AnimationCancel != null)
                AnimationCancel(Context, new AnimatorEventArgs(animation));

        }
        public void OnAnimationEnd(Animator animation)
        {
            if (AnimationEnd != null)
                AnimationEnd(Context, new AnimatorEventArgs(animation));
        }
        public void OnAnimationRepeat(Animator animation)
        {
            if (AnimationRepeat != null)
                AnimationRepeat(Context, new AnimatorEventArgs(animation));
        }
        public void OnAnimationStart(Animator animation)
        {
            if (AnimationStart != null)
                AnimationStart(Context, new AnimatorEventArgs(animation));
        }
    }
