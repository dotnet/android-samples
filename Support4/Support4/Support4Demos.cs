...
namespace Support4
{
	[Activity (Label = "Support4Demos", MainLauncher = true, Theme = "@style/ThemeHolo")]
	public class Support4Demos : ListActivity
	{
		public const string SAMPLE_CATEGORY = "mono.support4demo.sample";
		...
		private List<ActivityListItem> GetDemoActivities (string prefix)
		{
			...
			query.AddCategory (Support4Demos.SAMPLE_CATEGORY);
