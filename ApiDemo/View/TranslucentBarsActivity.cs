...
namespace MonoDroid.ApiDemo
{
 	...
 	*/
	[Activity (Label = "Views/System UI Visibility/Translucent Bars",
		Theme = "@android:style/Theme.Holo.NoActionBar.TranslucentDecor")]
	[IntentFilter (new[] { Intent.ActionMain }, Categories = new string[] { ApiDemo.SAMPLE_CATEGORY })]		
	public class TranslucentBarsActivity : Activity
	{
		protected override void OnCreate (Bundle bundle)
		{
			base.OnCreate (bundle);
			SetContentView (Resource.Layout.translucent_bars);
		}
	}
}
