...
namespace MonoDroid.ApiDemo
{
	...
	public class ContentBrowserActivity : Activity, SearchView.IOnQueryTextListener, ActionBar.ITabListener
	{
		...
		public class Content : ScrollView, View.IOnSystemUiVisibilityChangeListener, View.IOnClickListener
		{
			...
			TextView mTitleView;
			SeekBar mSeekView;
			SystemUiFlags mBaseSystemUiVisibility = SystemUiFlags.Fullscreen | SystemUiFlags.LayoutStable;
			...
			SystemUiFlags BaseSystemUiVisibility {
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView (Resource.Layout.content_browser);
