...
namespace MonoDroid.ApiDemo
{
	...
	public class AlertDialogSamples : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			two_buttons_old_school.Click += delegate {
			...
			two_buttons_holo.Click += delegate {
