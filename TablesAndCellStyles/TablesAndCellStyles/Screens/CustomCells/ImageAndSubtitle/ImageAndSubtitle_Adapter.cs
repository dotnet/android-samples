...
namespace TablesAndCellStyles {
    //Since: API Level 1 
    public class ImageAndSubtitle_Adapter : ArrayAdapter <Tuple<string,string,int>> {
        Activity context;
        public ImageAndSubtitle_Adapter(Activity context, IList<Tuple<string, string, int>> objects)
