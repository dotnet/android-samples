...
namespace Novell.MonoDroid.Samples.ContactManager
{
	...
	public class ContactAdder : Activity, OnAccountsUpdateListener
	{
		public static string TAG = "ContactsAdder";
		...
		protected override void OnCreate (Bundle savedInstanceState)
		{
			...
			//       separately.
			mContactPhoneTypes = new List<int> ();
			...
			mContactEmailTypes = new List<int> ();
			...
			mAccounts = new List<AccountData> ();
			mAccountAdapter = new AccountAdapter (this, mAccounts);
			mAccountSpinner.Adapter = mAccountAdapter;
		 ...
		 */
		private class AccountAdapter // : ArrayAdapter<AccountData>
		{
