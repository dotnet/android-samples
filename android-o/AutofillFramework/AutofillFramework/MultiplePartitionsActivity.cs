...
namespace AutofillFramework
{
    ...
    public class MultiplePartitionsActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            mCredentialsPartition.AddLine("username", (int) AutofillType.Text,
                GetString(Resource.String.username_label),
                "         ", false, View.AutofillHintUsername);
            mCredentialsPartition.AddLine("password", (int) AutofillType.Text,
                GetString(Resource.String.password_label),
                "         ", true, View.AutofillHintPassword);

            var ccExpirationType = (int) AutofillType.Date;
            ...
            mCcPartition.AddLine("ccNumber", (int) AutofillType.Text,
                GetString(Resource.String.credit_card_number_label),
                "         ", true, View.AutofillHintCreditCardNumber);
            mCcPartition.AddLine("ccDay", (int) AutofillType.Text,
            ...
            mCcPartition.AddLine("ccYear", (int) AutofillType.Text,
            ...
            mCcPartition.AddLine("ccSecurityCode", (int) AutofillType.Text,
